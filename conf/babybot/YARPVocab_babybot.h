...
///
/// $Id: YARPVocab_babybot.h,v 2.1 2006-07-21 19:55:53 babybot Exp $
///
///
...
const char *const YBVArmForceNewVelCmd = "ArmForceNewVelCmd";
...
const char *const YBVKFTrainStart = "KFTrainStart";
