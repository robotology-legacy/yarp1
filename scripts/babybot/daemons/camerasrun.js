...
WshShell.Run ("on -d -n hades \"framegrab.exe -b 0 -name left -l -net Net1 -o 4\"", 7, true);
WshShell.Run ("on -d -n hades \"framegrab.exe -b 1 -name right -l -net Net1 -o -4\"", 7, true);
