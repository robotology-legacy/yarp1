...
/***************************************************************************
 ...
 |                  Windows 3.1 16-bit, Windows NT, QNX 4.24               |
 |                                                                         |
...
/* it needs to be on, so people can use it. */
#undef COGQNX
#define COGQNX
...
#ifdef COGQNX /* maddog */
  /* ----------- Proxy features from the Cog Project ----------*/
  short (__PX_CALL *SetProxy)(pid_t proxy_pid);
  short (__PX_CALL *ArmProxy)(long fgh, long qh);
#endif
} PXC200;
