...
//Q4 #include <sys/kernel.h>
//Q4 #include <sys/proxy.h>
...
/* To customize the DMCQNX library for your own use, define
   or undefine one or more of the preprocessor variables below */

#define DMC_DEBUG               /* Enable debug trace */

#if defined(DMC_DEBUG)
//   #include <sys/trace.h>
//Q4   #include <sys/tracecod.h>
#endif

/* ISA bus communications */
//NN #define DMC_ISABUS              /* Enable base ISA bus communications */
...
//NN #define DMC_SERIAL              /* Enable base serial communications */

/* Ethernet communications */
//NN #define DMC_ETHERNET
...
/* Get the interrupt status from the Galil controller.
   ...
   hdmc              Handle to the Galil controller.
   PUSHORT           Buffer to recieve the interrupt status. Output only. */
