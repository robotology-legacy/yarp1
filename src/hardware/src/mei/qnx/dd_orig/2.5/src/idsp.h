...
*/
#	define	TRIGGER_NEGATIVE		(unsigned16)0x8000
#	define	TRIGGER_POSITIVE		(unsigned16)0x0000 /* !TRIGGER_NEGATIVE. */
...
#	define	CD_ANALOG					(unsigned16)0x01
#	define	CD_PARALLEL					(unsigned16)0x02
#	define	CD_FEEDBACK_MASK			(unsigned16)0x07
#	define	CD_DUAL						(unsigned16)0x08
#	define	CD_CAM						(unsigned16)0x10
#	define	CD_INTEGRATION				(unsigned16)0x20
#	define	CD_JOG						(unsigned16)0x40
#	define	CD_UNIPOLAR					(unsigned16)0x80
#	define	CD_STEPPER					(unsigned16)0x100
#	define	CD_USER_ANALOG				(unsigned16)0x200
#	define	CD_FEEDBACK_CHECK			(unsigned16)0x400
#	define	CD_SIN_INTERP				(unsigned16)0x800
#	define	CD_SIN_COMM					(unsigned16)0x2000
#	define	CD_KILL_AXIS				(unsigned16)0x8000
