...
main ( int argc, char *argv[] )
	...
	ApLinkWindow( NULL, &appl_links[1], NULL );
	ApLinkWindow( NULL, &appl_links[2], NULL );
	ApLinkWindow( NULL, &appl_links[3], NULL );
...
ApClassInit( void )
	...
	ApAddClass( "PtFileSel", &PtFileSel );
	ApAddClass( "PtText", &PtText );
	ApAddClass( "PtLine", &PtLine );
