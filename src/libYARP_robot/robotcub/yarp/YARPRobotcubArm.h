...
#ifndef __YARPRobotcubArmh__
#define __YARPRobotcubArmh__


#include <yarp/YARPConfig.h>
#include <yarp/YARPGenericControlBoard.h>
#include <yarp/YARPCanOnRobotcubArmAdapter.h>

/**
 * \file YARPRobotcubArm.h It contains definitions and the class defining
...
/**
 * YARPRobotcubArm is the specialization of the generic control board to control
 ...
 *
 */
class YARPRobotcubArm: public YARPGenericControlBoard<YARPCanOnRobotcubArmAdapter, YARPRobotcubArmParameters>
{
public:
	// empty for now!
};
