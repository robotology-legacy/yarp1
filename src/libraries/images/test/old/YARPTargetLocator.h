...
//	YARPColorLocator (int size, int nbinssat, int nbinshue, double luma_thr, double sat_thr);
	YARPColorLocator (int size, int nbinv, int nbinssat, int nbinshue, double luma_thr, double sat_thr);
	YARPColorLocator ();
	~YARPColorLocator ();

//	void Resize (int size, int nbinssat, int nbinshue, double luma_thr, double sat_thr);
	void Resize (int size, int nbinv, int nbinssat, int nbinshue, double luma_thr, double sat_thr);
...
//	double CompareHisto (CStaticLut<int>& x1, CStaticLut<int>& x2);
	double CompareHisto (CStaticLut3D<int>& x1, CStaticLut3D<int>& x2);
