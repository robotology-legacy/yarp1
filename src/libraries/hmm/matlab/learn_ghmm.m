...
% 
% [LL, PRIOR, TRANSMAT, MU, SIGMA, MU_HISTORY] = LEARN_MHMM(...
%     DATA, PRIOR0, TRANSMAT0, MU0, SIGMA0)
% computes the ML estimates of the following parameters,
% where, for each time t, Q(t) is the hidden state, and Y(t) is the observation:
%   prior(i) = Pr(Q(1) = i), 
...
%  LEARN_MHMM(DATA, INIT_STATE_PROB, TRANSMAT, MU, SIGMA, ...
%    MAX_ITER, THRESH, VERBOSE, COV_TYPE, STATIC)
...
if nargin<9, cov_type = 'full'; end
if nargin<10, static = 0; end
