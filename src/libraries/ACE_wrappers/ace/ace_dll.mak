...
!MESSAGE No configuration specified. Defaulting to ACE DLL - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "ACE DLL - Win32 MFC Release" && "$(CFG)" != "ACE DLL - Win32 MFC Debug" && "$(CFG)" != "ACE DLL - Win32 Release" && "$(CFG)" != "ACE DLL - Win32 Debug"
...
CPP_PROJ=/nologo /MD /W3 /GX /Zi /O2 /Ob2 /I "../" /I "../PACE" /I "..\..\..\..\include" /D "NDEBUG" /D ACE_HAS_MFC=1 /D ACE_DOESNT_INSTANTIATE_NONSTATIC_OBJECT_MANAGER=1 /D "WIN32" /D "_WINDOWS" /D "ACE_BUILD_DLL" /D "ACE_OS_BUILD_DLL" /D "__WIN32__" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\acemfc.pdb" /map:"$(INTDIR)\acemfc.map" /debug /machine:I386 /out:"..\bin\acemfc.dll" /implib:"$(OUTDIR)\acemfc.lib" 
LINK32_OBJS= \
	"$(INTDIR)\ACE.obj" \
...
$(DS_POSTBUILD_DEP) : "..\bin\acemfc.dll"
   copy ..\bin\acemfc.dll ..\..\..\..\bin\winnt
	copy .\acemfc.lib ..\..\..\..\lib\winnt
	copy .\*.h ..\..\..\..\include\ace
	copy .\*.inl ..\..\..\..\include\ace
	copy .\*.i ..\..\..\..\include\ace
	copy .\*.cpp ..\..\..\..\include\ace
...
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /Zi /Od /Gy /I "../" /I "../PACE" /I "..\..\..\..\include" /D "_DEBUG" /D ACE_HAS_MFC=1 /D ACE_DOESNT_INSTANTIATE_NONSTATIC_OBJECT_MANAGER=1 /D "WIN32" /D "_WINDOWS" /D "ACE_BUILD_DLL" /D "ACE_OS_BUILD_DLL" /D "__WIN32__" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /nologo /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\acemfcd.pdb" /debug /machine:I386 /out:"..\bin\acemfcd.dll" /implib:"$(OUTDIR)\acemfcd.lib" 
LINK32_OBJS= \
	"$(INTDIR)\ACE.obj" \
	"$(INTDIR)\Activation_Queue.obj" \
	"$(INTDIR)\Active_Map_Manager.obj" \
...
$(DS_POSTBUILD_DEP) : "..\bin\acemfcd.dll"
   copy ..\bin\acemfcd.dll ..\..\..\..\bin\winnt
	copy .\acemfcd.lib ..\..\..\..\lib\winnt
	copy .\*.h ..\..\..\..\include\ace
	copy .\*.inl ..\..\..\..\include\ace
	copy .\*.i ..\..\..\..\include\ace
	copy .\*.cpp ..\..\..\..\include\ace
...
CPP_PROJ=/nologo /MD /W3 /GX /Zi /O2 /Ob2 /I "../" /I "../PACE" /I "..\..\..\..\include" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "ACE_BUILD_DLL" /D "ACE_OS_BUILD_DLL" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
MTL_PROJ=/nologo /D "NDEBUG" /mktyplib203 /o /win32 "NUL" 
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\ace.res" /d "NDEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\ace.bsc" 
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\ace.pdb" /map:"$(INTDIR)\ace.map" /debug /machine:I386 /out:"..\bin\ace.dll" /implib:"$(OUTDIR)\ace.lib" 
LINK32_OBJS= \
	"$(INTDIR)\ACE.obj" \
	"$(INTDIR)\Activation_Queue.obj" \
	"$(INTDIR)\Active_Map_Manager.obj" \
...
$(DS_POSTBUILD_DEP) : "..\bin\ace.dll"
   copy ..\bin\ace.dll ..\..\..\..\bin\winnt
	copy .\ace.lib ..\..\..\..\lib\winnt
	copy .\*.h ..\..\..\..\include\ace
	copy .\*.inl ..\..\..\..\include\ace
	copy .\*.i ..\..\..\..\include\ace
	copy .\*.cpp ..\..\..\..\include\ace
...
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /Zi /Od /Gy /I "..\..\..\..\include" /I "../" /I "../PACE" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "ACE_BUILD_DLL" /D "ACE_OS_BUILD_DLL" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
MTL_PROJ=/nologo /D "_DEBUG" /mktyplib203 /o /win32 "NUL" 
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\ace.res" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\ace.bsc" 
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /nologo /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\aced.pdb" /debug /machine:I386 /out:"..\bin\aced.dll" /implib:"$(OUTDIR)\aced.lib" 
LINK32_OBJS= \
	"$(INTDIR)\ACE.obj" \
	"$(INTDIR)\Activation_Queue.obj" \
	"$(INTDIR)\Active_Map_Manager.obj" \
...
$(DS_POSTBUILD_DEP) : "..\bin\aced.dll"
   copy ..\bin\aced.dll ..\..\..\..\bin\winnt
	copy .\aced.lib ..\..\..\..\lib\winnt
	copy .\*.h ..\..\..\..\include\ace
	copy .\*.inl ..\..\..\..\include\ace
	copy .\*.i ..\..\..\..\include\ace
	copy .\*.cpp ..\..\..\..\include\ace
...
"$(INTDIR)\Asynch_Pseudo_Task.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\Based_Pointer_Repository.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\DLL_Manager.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\Framework_Component.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\MEM_Acceptor.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\MEM_Connector.obj" : $(SOURCE) "$(INTDIR)"


SOURCE=.\MEM_IO.cpp

"$(INTDIR)\MEM_IO.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\MEM_SAP.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\NT_Service.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\PI_Malloc.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\POSIX_Asynch_IO.obj" : $(SOURCE) "$(INTDIR)"


SOURCE=.\POSIX_Proactor.cpp

"$(INTDIR)\POSIX_Proactor.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\Service_Templates.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\Svc_Handler.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\Template_Instantiations.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\Thread_Adapter.obj" : $(SOURCE) "$(INTDIR)"


SOURCE=.\Thread_Control.cpp

"$(INTDIR)\Thread_Control.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\Timeprobe.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\Timer_Queue_Adapters.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\WIN32_Asynch_IO.obj" : $(SOURCE) "$(INTDIR)"


SOURCE=.\WIN32_Proactor.cpp

"$(INTDIR)\WIN32_Proactor.obj" : $(SOURCE) "$(INTDIR)"
