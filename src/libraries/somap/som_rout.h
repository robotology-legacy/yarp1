...
struct entries_tag *randinit_codes(struct entries_tag *data, int topol, int neigh, int xdim, int ydim, float* min, float* max);
struct entries_tag *lininit_codes(struct entries_tag *data, int topol, int neigh, int xdim, int ydim);
