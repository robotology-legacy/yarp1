...
* Revision 1.9  2003/12/30 22:07:05  ddennedy
* bugfix possible abort writing JUNK chunk before AVIX
*
* Revision 1.8  2003/12/27 20:07:22  schirmacher
* bugfixes for DVGRAB-17, DVGRAB-19 and partially DVGRAB-16
* (capture aborted for files larger than 1008 MByte)
*
* Revision 1.7  2003/11/16 22:36:49  ddennedy
* run make pretty and remove deprecated strstream
*
* Revision 1.6  2003/11/12 13:03:21  ddennedy
* fix smpte314m speed determination, remove junk chunks from movi list in avi
*
...
*
* Revision 1.3  2003/03/05 15:17:35  ddennedy
* type2 AVI fix
*
