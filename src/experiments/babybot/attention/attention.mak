# Microsoft Developer Studio Generated NMAKE File, Based on attention.dsp
!IF "$(CFG)" == ""
CFG=attention - Win32 Debug
!MESSAGE No configuration specified. Defaulting to attention - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "attention - Win32 Release" && "$(CFG)" != "attention - Win32 Debug"
...
ALL : "$(OUTDIR)\attention.exe"


CLEAN :
	-@erase "$(INTDIR)\att.obj"
	-@erase "$(INTDIR)\attbehavior.obj"
	-@erase "$(INTDIR)\attention.obj"
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(OUTDIR)\attention.exe"
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\attention.exe"
   copy .\Release\attention.exe ..\..\..\..\bin\winnt
...
CLEAN :
	...
	-@erase "$(OUTDIR)\attention.exe"
	-@erase "$(OUTDIR)\attention.ilk"
	-@erase "$(OUTDIR)\attention.pdb"
...
LINK32=link.exe
LINK32_FLAGS=aced.lib motorcontroldb.lib mathdb.lib utilsdb.lib alldriversdb.lib winmm.lib os_servicesDB.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\attention.pdb" /debug /machine:I386 /out:"$(OUTDIR)\attention.exe" /pdbtype:sept /libpath:"..\..\..\..\lib\winnt" 
LINK32_OBJS= \
	"$(INTDIR)\att.obj" \
	"$(INTDIR)\attbehavior.obj" \
	"$(INTDIR)\attention.obj"
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\attention.exe"
   copy .\debug\attention.exe ..\..\..\..\bin\winnt
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"
...
!IF EXISTS("attention.dep")
!INCLUDE "attention.dep"
!ELSE 
!MESSAGE Warning: cannot find "attention.dep"
!ENDIF 
!ENDIF 
