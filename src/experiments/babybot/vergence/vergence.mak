# Microsoft Developer Studio Generated NMAKE File, Based on vergence.dsp
!IF "$(CFG)" == ""
CFG=vergence - Win32 Debug
!MESSAGE No configuration specified. Defaulting to vergence - Win32 Debug.
!ENDIF 
...
RSC=rc.exe
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\vergence.bsc" 
BSC32_SBRS= \
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\vergence.exe"
   copy .\Release\vergence.exe  ..\..\..\..\bin\winnt
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\vergence.exe"
   copy  .\Debug\vergence.exe  ..\..\..\..\bin\winnt
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"
...
!IF EXISTS("vergence.dep")
!INCLUDE "vergence.dep"
!ELSE 
!MESSAGE Warning: cannot find "vergence.dep"
!ENDIF 
!ENDIF 
