...
// Author: J. Norberto Pires      Date: 19.04.97  Last Edit: 13.06.01
// Revision:                      Date:
...
short read_jr3(unsigned short, short);

// Write data to JR3
// Input parameters: address, value_to_write, processor number
void write_jr3(unsigned short, unsigned short, short);

// Command JR3
// Input parameters: address, value_to_write, processor number
// Return Value: 0 if command was sucessful
short command_jr3(unsigned short, unsigned short, short);

// Reads System Warnings
// Input parameters: processor number
// Return Value: warning info in a f_m_saturation format
struct f_m_saturation system_warnings(short);

// Reads System Errors (all)
// Input parameters: processor number
// Return Value: error info in a error_bits format
struct error_bits system_errors(short);

// Reads Saturation Errors
// Input parameters: processor number
// Return Value: saturation errors info in a f_m_saturation format
struct f_m_saturation saturation(short);

//** Individual relevant error bits **********************

// Checks System Busy
// Input parameters: processor number
short system_busy(short);

// Checks Memory Error
// Input parameters: processor number
short system_memory_error(short);

// Checks Sensor Change
// Input parameters: processor number
short system_sensor_change(short);

// Checks Cal_Crc_Bad
// Input parameters: processor number
short system_cal_crc_bad(short);

// Checks Watch_Dog2
// Input parameters: processor number
short system_watch_dog2(short);

// Checks Watch_Dog
// Input parameters: processor number
short system_watch_dog(short);
...
short init_jr3(unsigned long, unsigned long, unsigned long, short, short);
