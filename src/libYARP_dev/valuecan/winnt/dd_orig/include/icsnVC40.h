...
// Copyright Intrepid Control Systems, Inc. 2000-2003
// www.intrepidcs.com
////////////////////////////////////////////////////////////////////////////////////
...
BORLANDC_HEADER int _stdcall icsneoOpenPortEx(	int lPortSerialNumber, 
								int lPortType, int lDriverType, int lIPAddressMSB, 
								int lIPAddressLSBOrBaudRate, int bConfigRead, 
								unsigned char * bNetworkID, int * hObject);BORLANDC_FOOTER
...
BORLANDC_HEADER int _stdcall icsneoFindAllUSBDevices(int lDriverType,
									 unsigned int iGetSerialNumbers,
									 unsigned int *iDevices, 
									 unsigned int *iSerialNumbers,
									 unsigned int *iOpenedStates,
									 unsigned int * iNumDevices); BORLANDC_FOOTER
