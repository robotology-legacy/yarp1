...
\title{
YARP Network Protocol Specification
}
...
\noindent
This document describes YARP network protocol version 2.0.  At the time of
writing, the C++ version of YARP does not fully support this protocol,
but there is a reference Java implementation of the specification.
\end{abstract}
